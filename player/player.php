                ...
                <table>
                    ...
                    <?php foreach ($villages as $v): ?>
                        <tr>
                            ...
                            <td><a href="../map/map.php?center_x=<?php echo $v['x_coord']; ?>&center_y=<?php echo $v['y_coord']; ?>" class="btn btn-secondary" style="padding:4px 10px; font-size:0.95em; margin:0;">Pokaż na mapie</a></td>
                        </tr>
                    <?php endforeach; ?>
                </table>
                <?php endif; ?>
