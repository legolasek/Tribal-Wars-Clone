...
<div id="game-container">
    ...
    <div id="main-content">
        <nav id="sidebar">
            <ul>
                <li><a href="../game/game.php">🏠 Wioska</a></li>
                <li><a href="../map/map.php">🗺️ Mapa</a></li>
                <li><a href="../combat/attack.php">⚔️ Atak</a></li>
                <li><a href="../messages/reports.php">📜 Raporty</a></li>
                <li><a href="../messages/messages.php">✉️ Wiadomości</a></li>
                <li><a href="../player/ranking.php">🏆 Ranking</a></li>
                <li><a href="../player/settings.php">⚙️ Ustawienia</a></li>
                <li><a href="../auth/logout.php">🚪 Wyloguj</a></li>
            </ul>
        </nav>
        <main>
