...
require_once 'lib/BuildingManager.php'; // Potrzebne do sprawdzenia wymagań i obliczeń czasu
require_once 'lib/ResourceManager.php'; // Potrzebne do wyświetlenia aktualnych zasobów
...
foreach ($researches_to_display as $research) {
    ...
    echo '      <span class="cost-item ' . ($current_wood >= $research['wood_cost'] ? 'enough' : 'not-enough') . '"><img src="img/ds_graphic/resources/wood.png" alt="Drewno"> ' . formatNumber($research['wood_cost']) . '</span> ';
    echo '      <span class="cost-item ' . ($current_clay >= $research['clay_cost'] ? 'enough' : 'not-enough') . '"><img src="img/ds_graphic/resources/clay.png" alt="Glina"> ' . formatNumber($research['clay_cost']) . '</span> '; // Poprawiono klucz na clay_cost
    echo '      <span class="cost-item ' . ($current_iron >= $research['iron_cost'] ? 'enough' : 'not-enough') . '"><img src="img/ds_graphic/resources/iron.png" alt="Żelazo"> ' . formatNumber($research['iron_cost']) . '</span>';
    echo '    </div>';
