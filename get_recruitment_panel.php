...
require_once 'lib/BuildingManager.php'; // Need BuildingManager to get building level
...
foreach ($availableUnits as $unit_data) { // Zmieniona pętla
    ...
    echo ' <span class="resource-cost">Koszt: <img src="img/resources/wood.png" title="Drewno" alt="Drewno" class="resource-icon-small">' . $cost_wood . ' <img src="img/resources/clay.png" title="Glina" alt="Glina" class="resource-icon-small">' . $cost_clay . ' <img src="img/resources/iron.png" title="Żelazo" alt="Żelazo" class="resource-icon-small">' . $cost_iron . '</span>';
    echo '</div>';
}
