            ...
            if (!empty($smithy_research_types)) {
                ...
                foreach ($smithy_research_types as $research) {
                    ...
                    if (!$is_at_max_level && !$is_in_progress) {
                        if ($is_available) {
                            $researchHtml .= '<td><img src="img/resources/wood.png" title="Drewno" alt="Drewno"> ' . $cost['wood'] . '</td>';
                            $researchHtml .= '<td><img src="img/resources/clay.png" title="Glina" alt="Glina"> ' . $cost['clay'] . '</td>';
                            $researchHtml .= '<td><img src="img/resources/iron.png" title="Żelazo" alt="Żelazo"> ' . $cost['iron'] . '</td>';
